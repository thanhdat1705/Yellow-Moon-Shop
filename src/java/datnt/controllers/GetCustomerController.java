...
import static datnt.controllers.GetPaymentMethodController.LOGGER;
...
public class GetCustomerController extends HttpServlet {
    ...
    static final Logger LOGGER = Logger.getLogger(GetCustomerController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (userLogin != null) {
                ...
                request.setAttribute("CUSTOMER_INFO", cusDTO);
//            } else if (cusId != null) {
//                CustomerDAO cusDAO = new CustomerDAO();
//                CustomerDTO cusDTO = cusDAO.getCustomerByCusId(Integer.parseInt(cusId));
//                request.setAttribute("CUSTOMER_INFO", cusDTO);
            } else {
                request.setAttribute("CUSTOMER_INFO", "no cus");
            }
