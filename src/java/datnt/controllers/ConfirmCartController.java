...
public class ConfirmCartController extends HttpServlet {
    ...
    static final Logger LOGGER = Logger.getLogger(ConfirmCartController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                if (cartList == null) {
                    foundErr = true;
                    request.setAttribute("NOTIFICATIONS_ADDTOCART", "Your shopping cart session has timed out.");
                    url = SHOPPING_PAGE;
                }
            }
        } finally {
